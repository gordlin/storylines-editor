<template>
    <div class="editor-container">
        ...
        <!-- Header bar -->
        <div class="sticky top-0 bg-white z-20 border-b border-gray-200 max-h-full">
            <div class="flex flex-row justify-between items-center px-3 py-0.5 md:py-0">
                <div class="flex flex-row items-center gap-4">
                    <!-- Back to landing page button -->
                    <router-link
                        :to="{ name: 'home' }"
                        class="flex flex-row items-center gap-2 w-fit py-3"
                        v-tippy="{
                            delay: '200',
                            placement: 'right',
                    ...
                    >
                        ...
                        <p class="hidden md:block border md:border-0 border-black font-medium">Leave editor</p>
                    </router-link>
                    ...
                    >
                        <svg
                            class="inline self-center mb-0.5"
                ...
                <div class="space-x-2 flex flex-row items-center">
                    ...
                    <span v-if="unsavedChanges" class="text-red-700 truncate">
                    ...
                    <!-- ENG/FR page toggle -->
                    <router-link
                        v-if="!currentRoute.includes('index-ca-en.html') && !currentRoute.includes('index-ca-fr.html')"
                        :to="{
                            name: 'editor',
                            params: { lang: currentRoute.includes('#/en') ? 'fr' : 'en', uuid: uuid }
                        }"
                        v-tippy="{
                            delay: '200',
                            placement: 'bottom',
                        ...
                        class="underline text-black font-medium w-8 md:w-auto truncate"
                    >
                        <a>
                            {{ currentRoute.includes('#/en') ? 'French' : 'English' }}
                        </a>
                    </router-link>
                </div>
            </div>
