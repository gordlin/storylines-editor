...
import { getCurrentInstance, ref, shallowRef, useTemplateRef } from 'vue';
...
function saveChanges(): void {
    if (
        editingSlide.value !== -1 &&
        slide !== undefined &&
        typeof (slide as typeof ImageEditorV | ChartEditorV).saveChanges === 'function'
    ) {
        (slide as typeof ImageEditorV | ChartEditorV).saveChanges();
    }
}
</script>
