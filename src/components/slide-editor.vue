        ...
        <div v-if="!!currentSlide">
            ...
            >
                ...
                <button
                    ...
                    :class="[panelIndex == 0 && !advancedEditorView ? 'font-bold' : 'font-semibold']"
                >
                ...
                <button
                    ...
                    :class="[panelIndex == 1 && !advancedEditorView ? 'font-bold' : 'font-semibold']"
                >
                    <div class="align-middle inline-block">
                        <svg
                            clip-rule="evenodd"
                ...
                <button
                    ...
                    :class="[advancedEditorView ? 'font-bold' : 'font-semibold']"
                >
